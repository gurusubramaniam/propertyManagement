      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-5">
              <h3 className="text-sm font-medium text-gray-900">Manage Properties</h3>
              <p className="mt-1 text-sm text-gray-500">View and manage your properties</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-5">
              ...
              <p className="mt-1 text-sm text-gray-500">View and manage your tenants</p>
            </div>
          </div>
        </Link>
