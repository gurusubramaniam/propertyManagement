    ...
    <div className="space-y-6">
      ...
      {showRecordPayment && (
        <div className="fixed inset-0 z-[100]">
          <div className="fixed inset-0 bg-black/60" onClick={() => setShowRecordPayment(false)} />
        ...
        <div className="fixed inset-0 overflow-y-auto bg-black/60 flex items-center justify-center p-4 z-[100]">
          <div className="relative bg-white rounded-lg shadow-xl p-8 max-w-lg w-full mx-4 my-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-semibold text-gray-900">Record Payment</h2>
              <button
                onClick={() => setShowRecordPayment(false)}
