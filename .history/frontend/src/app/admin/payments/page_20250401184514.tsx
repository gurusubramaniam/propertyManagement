    ...
    <div className="space-y-6">
      ...
      {showRecordPayment && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-surface rounded-lg shadow-xl p-8 max-w-lg w-full">
            ...
            <form onSubmit={handleRecordPayment} className="space-y-6">
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="mt-1 block w-full rounded-lg border-border bg-background text-primary px-3 py-2 shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-500/20 focus:ring-opacity-50 sm:text-sm"
                  required
                >
              ...
              <div className="space-y-1">
                ...
                <div className="relative mt-1 rounded-lg shadow-sm">
                  ...
                  <input
                    ...
                    className="block w-full rounded-lg border-border bg-background text-primary pl-7 pr-3 py-2 focus:border-primary-500 focus:ring focus:ring-primary-500/20 focus:ring-opacity-50 sm:text-sm"
                    required
                    step="0.01"
                    min="0"
                    placeholder="0.00"
              ...
              <div className="space-y-1">
                <label htmlFor="paymentMethod" className="block text-sm font-medium text-secondary">
                  Payment Method
                </label>
                <select
                  id="paymentMethod"
              ...
              <div className="flex justify-end space-x-3 pt-6">
                <button
                  type="button"
                  onClick={() => setShowRecordPayment(false)}
                  className="px-4 py-2 border border-border text-secondary rounded-lg hover:bg-surface-dark focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors"
                >
                  Cancel
                </button>
                <button
