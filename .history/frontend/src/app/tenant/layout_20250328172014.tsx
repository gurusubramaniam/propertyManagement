      ...
      <nav className="bg-gray-900 border-b border-gray-800">
        ...
        <div className={`${isMenuOpen ? 'block' : 'hidden'} sm:hidden bg-gray-900`}>
          <div className="pt-2 pb-3 space-y-1">
            ...
            <button
              onClick={handleLogout}
              className="block w-full text-left pl-3 pr-4 py-2 border-l-4 text-base font-medium border-transparent text-gray-300 hover:bg-gray-800 hover:border-gray-300 hover:text-white"
            >
              Logout
            </button>
          </div>
