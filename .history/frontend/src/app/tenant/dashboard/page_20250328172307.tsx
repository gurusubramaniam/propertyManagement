  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-gray-800 pb-6">
        ...
        <p className="text-gray-400">Here's an overview of your property and payments.</p>
      </div>
          ...
          <div className="bg-gray-900 rounded-lg border border-gray-800 overflow-hidden">
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-sm font-medium text-gray-400">Property Name</h3>
                  <p className="mt-1 text-white">{leaseInfo.propertyName}</p>
                  <p className="text-sm text-gray-400">{leaseInfo.address}</p>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-sm font-medium text-gray-400">Monthly Rent</h3>
                    <p className="mt-1 text-lg font-semibold text-blue-400">
                      ${parseFloat(leaseInfo.rentAmount).toFixed(2)}
                    </p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-400">Next Payment Due</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-400">Lease Period</h3>
                  <p className="mt-1 text-white">
